...
module.exports.handler = async (event) => {
    try {
        ...
        items = await getAllItemsWithFilter(BIOET_PRECIOS_TABLE_NAME, 'bioetMaiz', bioetMaiz, pageSizeNro, orderAt);
        ...
        console.log(`Error in getLikeBioetMaiz lambda, caused by ${{error}}`);
