...
const BIOET_TIPO_KEY_DYNAMO = 'estadoOperativo';
...
module.exports.handler = async (event) => {
  try {
    ...
    if (estadoOperativo == (null || undefined)) {
      return await bodyResponse(
        BAD_REQUEST_CODE,
        'Bad request, check missing or malformed path parameters',
      );
    ...
    msgResponse = 'ERROR in get-like-estado-operativo() function for bioetanol-tipos.';
